  ...
  return (
    <form className="flex flex-col gap-y-5 p-6 bg-white shadow-md rounded-md">
      <div className="mx-auto flex gap-x-5 items-center">
        ...
        />
        <button className="px-8 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition-colors duration-300">
          Add URL
        </button>
      </div>

      <button className="mx-auto px-5 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition-colors duration-300">
        Start download!
      </button>
    </form>
  );
