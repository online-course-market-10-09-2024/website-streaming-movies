...
type MovieCategoryController struct {
	service services.MovieCategoryService
}

func (c *MovieCategoryController) Count(w http.ResponseWriter, r *http.Request) {
...
func (c *MovieCategoryController) GetAll(w http.ResponseWriter, r *http.Request) {
...
func (c *MovieCategoryController) Create(w http.ResponseWriter, r *http.Request) {
...
func (c *MovieCategoryController) Update(w http.ResponseWriter, r *http.Request) {
	// Get JSON from user input
	input := models.MovieCategory{}
	if err := json.NewDecoder(r.Body).Decode(&input); err != nil {
		render.Status(r, http.StatusBadRequest)
...
func (c *MovieCategoryController) Remove(w http.ResponseWriter, r *http.Request) {
